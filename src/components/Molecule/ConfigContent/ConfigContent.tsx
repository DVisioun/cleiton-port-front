...
function ConfigContent({ lang }:any) {
  ...
  return (
    <div className="sm-1:absolute fixed right-0 top-52 z-0 flex flex-col items-center justify-center gap-4 rounded-l-lg bg-secondary px-3 py-3 shadow lg:absolute">
      <button onClick={getHrefLink}><LanguageButton country={language} /></button>
      <ThemeButton />
    </div>
  )
}
